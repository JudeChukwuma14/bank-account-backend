...
//                     `SecureBank: Payment verified! Loan application #${loanId.slice(-8)} is now under review. Check email for details.`
//                 );
//                 smsSent = true;
//             } catch (smsError) {
...
//             try {
//                 await sendSMSNotification(loan.memberId.phone, 
//                     `SecureBank: Congratulations! Your ₦${loan.approvedAmount.toLocaleString()} loan is approved. Check email for details.`
//                 );
//                 smsSent = true;
//             } catch (smsError) {
//                 console.error('❌ Failed to send SMS notification:', smsError);
...
//             try {
//                 await sendSMSNotification(loan.memberId.phone, 
//                     `SecureBank: Update on your loan application. Please check your email for details.`
//                 );
//                 smsSent = true;
//             } catch (smsError) {
//                 console.error('❌ Failed to send SMS notification:', smsError);
...
//         try {
//             await sendSMSNotification(loan.memberId.phone, 
//                 `SecureBank: ₦${loan.disbursementAmount.toLocaleString()} loan disbursed to your account. Check email for repayment details.`
//             );
//             smsSent = true;
//         } catch (smsError) {
//             console.error('❌ Failed to send SMS notification:', smsError);
